    ...
    include("home/db_connect.php");
        ...
        if(isset($_POST['submit'])){
            ...
            if ($statement->rowCount() == 0){
                try{
                    $statement = $conn->prepare("INSERT INTO user_profile (city, business_id, zipcode, address_2, address_1, first_name, last_name, mobile_number, email_id, password, user_is, created_at)
                    VALUES (:city, :business_id, :zipcode, :address_2, :address_1, :first_name, :last_name, :mobile_number, :email_id, :password, 1, '".$date."')");
                    $statement->bindValue(':address_1', $address_1);
                    $statement->bindValue(':address_2', $address_2);
                    $statement->bindValue(':zipcode', $zipcode);
                    $statement->bindValue(':business_id', $business_id);
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav navbar-center me-auto mt-lg-0 mt-2">
					...
					<li class="nav-item">
                       <a href="referrer_signup.php" class="btn btn-sm nav-btn btn-primary mb-4 mb-lg-0 ms-auto" > Referar</a>
                    </li>
					<li class="nav-item">
                        <a href="vendor_signup.php" class="btn btn-sm nav-btn btn-primary mb-4 mb-lg-0 ms-auto" > Vendor</a>
                    </li>
			   ...
			   <form class="form-auth-small" action="" method="POST">
                    <div class="col-md-6">
								...
								<div class="form-group">
									...
									<input class="form-control" id="address_1" name="address_1" placeholder="Address 1">
								</div>
								</div>

                    <div class="col-md-6">
                                <div class="form-group">
									<input class="form-control" id="address_2" name="address_2" placeholder="Address 2">
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<input class="form-control" id="business_id" name="business_id" placeholder="Business ID">
								</div>
								<div class="form-group">
