...
error_reporting(E_ALL);
    ...
    include("db_connect.php");
        ...
        if(isset($_POST['submit'])){
            ...
            $email_id_mobile = $_POST['email_id_mobile'];
            $password = $_POST['password'];


            //CHECK IF USER ALREADY EXISTS
            $sql = "SELECT * FROM user_profile where (email_id = '$email_id_mobile' || mobile_number = '$email_id_mobile') && password = '$password' && user_is = 0";
            //echo $sql;
            ...
            if ($statement->rowCount() == 0){
                try{
                    echo "<script>alert('Account does not exist. Please create account');</script>"; 
                }catch(Exception $e){
                ...
                //Do next proceedings after login
...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="67">
  ...
  <Div class="container contact-form">
            ...
            <form method="post">
			                            <p class="margin-top-30 text-center">Sign up  <a href="vendor_signup.php">here</a></p>
                <h3>Referrer Sign In</h3>
               <div class="row">
			   ...
			   <div class="col-md-3">
                    ...
                    <div class="col-md-6">
								<div class="form-group">
									...
									<input type="email" class="form-control" id="email_id_mobile" name="email_id_mobile" placeholder="Email or Mobile">
								</div>
								<div class="form-group">
